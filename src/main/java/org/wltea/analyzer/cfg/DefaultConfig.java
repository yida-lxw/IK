...
public class DefaultConfig implements Configuration {
	...
	//配置属性——是否启用远程扩展词典
	private static final String ENABLE_REMOTE_EXT_DICT = "enable_remote_ext_dict";
	 ...
	 * 是否启用远程词典加载
	 */
	private boolean enableRemoteExtDict;
	 ...
	 */
	@Override
	public boolean enableRemoteExtDict() {
		return enableRemoteExtDict;
	}

	@Override
	public void setEnableRemoteExtDict(boolean enableRemoteExtDict) {
		this.enableRemoteExtDict = enableRemoteExtDict;
	}
	 ...
	 */
	@Override
	public void setEnableRemoteExtDict() {
		String enableRemoteExtDict = props.getProperty(ENABLE_REMOTE_EXT_DICT);
		this.enableRemoteExtDict = (null != enableRemoteExtDict && !"".equals(enableRemoteExtDict) &&
				("true".equalsIgnoreCase(enableRemoteExtDict) || "yes".equalsIgnoreCase(enableRemoteExtDict) ||
						"on".equalsIgnoreCase(enableRemoteExtDict) || "ok".equalsIgnoreCase(enableRemoteExtDict) ||
						"1".equalsIgnoreCase(enableRemoteExtDict)));
	}
